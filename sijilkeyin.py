...
if template_file and st.button("Jana Sijil Automatik"):
...
if st.session_state.generated:
    ...
    for idx, row in st.session_state.df.iterrows():
        ...
        if cols[2].button("PDF", key=f"pdf_{idx}"):
            ...
            cols[2].download_button(
                ...
                data=pdf_bytes,
                file_name=f"Sijil_{name}.pdf",
                mime="application/pdf"
            )

    # ================== Download All PNG / PDF ==================
    st.markdown("---")
    st.subheader("Muat Turun Semua Sijil Sekali")
    ...
    if st.button("Download All PNG"):
        ...
        zip_buffer.seek(0)
        st.download_button("Muat Turun Semua PNG", zip_buffer, "Sijil_All_PNG.zip", "application/zip")
    ...
    if st.button("Download All PDF"):
        ...
        zip_buffer.seek(0)
        st.download_button("Muat Turun Semua PDF", zip_buffer, "Sijil_All_PDF.zip", "application/zip")
