...
if st.session_state.input_done and template_file:
    st.markdown("<div style='text-align:center; margin:10px;'><button style='padding:10px 20px; font-weight:bold; background:#0b5ed7; color:white; border:none; border-radius:8px;' onclick=''>Generate Sijil</button></div>", unsafe_allow_html=True)
    if st.button("Generate Sijil"):
